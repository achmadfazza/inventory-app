          ...
          <tr>
            ...
            <td>
              ...
              <x-modal id="{{ $supplier->id }}" title="Ubah Data">
                <form action="{{ route('backoffice.supplier.update', $supplier->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  <x-input title="Nama Supplier" name="name" type="text" placeholder="Masukan Nama Supplier" value="{{ $supplier->name }}" />
                  <x-input title="Telp Supplier" name="telp" type="number" placeholder="Masukan Telp Supplier" value="{{ $supplier->telp }}" />
                  <x-input title="Alamat Supplier" name="address" type="text" placeholder="Masukan Alamat Supplier" value="{{ $supplier->address }}" />
