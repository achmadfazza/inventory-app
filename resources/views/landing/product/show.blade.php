...
<x-landing.container>
    <div class="lg:w-4/5 mx-auto flex flex-wrap justify-center bg-white p-6 rounded-lg border">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p class="leading-relaxed text-justify text-gray-500 text-xl">{{ $product->description }}</p>
            <div class="flex mt-6 items-center pb-5 border-b-2 mb-5 justify-between">
                <span class="text-xl font-bold text-gray-700 flex items-center">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg"
                        class="icon icon-tabler icon-tabler-database-import mr-1" width="24" height="24"
                ...
                <h1 class="{{ $product->unit > 200 ? 'text-green-700' : 'text-rose-700' }} text-xl font-bold">
                    {{ $product->unit}}
